...
namespace Neo.ApplicationFramework.Generated
{
    ...
    public partial class Screen1
    {
		...
		void Screen1_Opened(System.Object sender, System.EventArgs e)
		{
			...
			queryStartDate.Font = new Font("Impact", 12, System.Drawing.FontStyle.Regular);
			...
			queryEndDate.Font = new Font("Impact", 12, System.Drawing.FontStyle.Regular);
		...
		void SetDataTableColumnSize()
		{
			try
			{
				...
				DataGridViewColumn timeColumn = DataGridView.Columns[1];
				DataGridViewColumn firstDataColumn = DataGridView.Columns[2];
				DataGridViewColumn secondDataColumn = DataGridView.Columns[3];
		...
		void btnExport_Click(System.Object sender, System.EventArgs e)
		{
			...
			try{
				...
				{
					case 1:
						filepath = Path.Combine(Environment.CurrentDirectory, "Project Files",
					...
					case 2:
						...
						if (saveFileDialog.ShowDialog() == DialogResult.OK)
							Globals.UtilityScriptModule.CreateCSVFile(rs, saveFileDialog.FileName);
						break;
					case 3:
						string exportPath = Globals.Tags.ExportPath.Value.ToString().TrimEnd('\\');
						if(string.IsNullOrEmpty(exportFileName))
							Globals.UtilityScriptModule.CreateCSVFile(rs, exportPath + "\\" + exportDefaultName + " " + timeStamp + ".csv");
						else
							Globals.UtilityScriptModule.CreateCSVFile(rs, exportPath + "\\" + exportFileName + " " + timeStamp + ".csv");
						break;
				}
				// ***
			}
