...
namespace Neo.ApplicationFramework.Generated
{
	...
	public partial class Screen2 : Neo.ApplicationFramework.Controls.Screen.ScreenWindow, Neo.ApplicationFramework.Interfaces.ISupportMultiLanguage
	{
		...
		protected Neo.ApplicationFramework.Controls.Script.LineAdapter Line3
		{
			get
			{
				return this.AdapterService.CreateAdapter<Neo.ApplicationFramework.Controls.Script.LineAdapter>(this.m_Line3);
			}
		}
		
		protected Neo.ApplicationFramework.Controls.Script.ElementAdapter Picture
		{
			get
			{
				return this.AdapterService.CreateAdapter<Neo.ApplicationFramework.Controls.Script.ElementAdapter>(this.m_Picture);
			}
		}
